...
## Dataset
The excel dataset was obtained from Kaggle. It consists of 1000 rows and 9 columns. In order to make use of the dataset, an ETL process has to take place from Excel to SQL Server Management Studion(SSMS). To view the initial Excel dataset, click [here](https://github.com/mmustee/Retail-Sales-Analysis/tree/main/dataset)
## Support
